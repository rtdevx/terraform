...
output "private_web80_sg_group_vpc_id" {
  description = "The VPC ID"
  value       = aws_security_group.vpc-web-80.vpc_id
}

output "private_web80_group_id" {
  description = "The ID of the security group"
  value       = aws_security_group.vpc-web-80.id
}

output "private_web80_sg_group_name" {
  description = "The name of the security group"
  value       = aws_security_group.vpc-web-80.name
}
...
output "private_web443_sg_group_vpc_id" {
  description = "The VPC ID"
  value       = aws_security_group.vpc-web-443.vpc_id
}

output "private_web443_group_id" {
  description = "The ID of the security group"
  value       = aws_security_group.vpc-web-443.id
}

output "private_web443_sg_group_name" {
  description = "The name of the security group"
  value       = aws_security_group.vpc-web-443.name
}