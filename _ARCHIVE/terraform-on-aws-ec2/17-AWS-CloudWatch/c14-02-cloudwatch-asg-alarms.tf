...
# ! This policy still requires `Target Tracking Scaling Policy` (defined in c13-06-autoscaling-ttsp.tf).
...
resource "aws_cloudwatch_metric_alarm" "app1_asg_cwa_cpu_high" {
